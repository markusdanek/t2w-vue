<template>
<div>
  <HeroSmall title="Impressum" template="impressum"/>
  <div class="wrapper">
    <b-container>
          ...
          <b-col>
            ...
            <ul>
              <li>
                ...
                <span>team<span class="two">2</span>work Arbeitskräfteüberlassung GmbH</span>
              </li>
              <li>
                Design &amp; Entwicklung:
      ...
      <div class="terms-block">
        <b-row>
          <b-col>
            ...
            <ul>
              <li>
                <a target="_blank" href="static/files/AGB_Personalbereitstellung_2017.pdf">
                  &raquo; AGB für Personalbereitstellung - Stand {{year}} (PDF, 2MB)
                </a>
              </li>
              <li>
                <a target="_blank" href="static/files/AGB_Personalvermittlung_2017.pdf">
                  &raquo; AGB für Personalvermittlung - Stand {{year}} (PDF, 700KB)
                </a>
              </li>
            </ul>
            <hr />
      ...
      <div class="company-block">
        <b-row>
          <b-col>
            ...
            <p>Offenlegung gemäß Mediengesetz &sect; 25:</p>
            <ul>
              ...
              <li>DVR: <span>9155457</span></li>
              <li>Mitglied der WKÖ: <span>Fachgruppe Allgemeines Gewerbe </span></li>
              <li>Gewerbeordnung: <span>www.ris.bka.gv.at</span></li>
            </ul>
            <hr />
          </b-col>
        </b-row>
      ...
      <div class="cookies-block">
        <b-row>
          <b-col>
            <h3>Informationen zur Cookie-Nutzung</h3>
            <p>
              Ein Cookie ist eine kleine Textdatei, die an Ihren Computer gesendet wird, wenn Sie eine Webseite besuchen.
              Diese Datei erfasst Informationen zu Ihrem Besuch auf Websites und kann erneut gelesen werden,
              wenn Sie diese Seite zu einem späteren Zeitpunkt wieder besuchen. So hat diese Website eine geringere
              Ladezeit und Sie finden sich schneller zurecht.
            </p>
            <p>
              Der Schutz Ihrer Daten steht bei uns an oberster Stelle. Dafür nutzt team<span class="two">2</span>work entsprechende organisatorische
              und technische Maßnahmen. Wenn Sie Cookies dennoch deaktivieren möchten, können Sie dies in den
              Browsereinstellungen anpassen. Bitte beachten Sie, dass so Ihr Username und Passwort nicht länger auf unserer
      ...
      <div class="disclaimer-block">
        <b-row>
          ...
          Website des Anbieters kommt keinerlei Vertragsverhältnis zwischen dem Nutzer und dem Anbieter zustande.
              ...
              <p>
                2. Externe Links <br />
          Diese Website enthält Verknüpfungen zu Websites Dritter ("externe Links"). Diese Websites unterliegen
          der Haftung der jeweiligen Betreiber. Der Anbieter hat bei der erstmaligen Verknüpfung der externen
          Links die fremden Inhalte daraufhin überprüft, ob etwaige Rechtsverstöße bestehen. Zu dem Zeitpunkt waren
          ...
          Kontrolle der externen Links ist für den Anbieter ohne konkrete Hinweise auf Rechtsverstöße nicht zumutbar.
          ...
          Jede vom österreichischen Urheber- und Leistungsschutzrecht nicht zugelassene Verwertung bedarf der vorherigen
          ...
          Lediglich die Herstellung von Kopien und Downloads für den persönlichen, privaten und nicht kommerziellen
          ...
          der Google in den USA übertragen und dort gespeichert. Google wird diese Informationen benutzen, um Ihre
          ...
          anderen Daten der Google in Verbindung bringen. Sie können die Installation der Cookies durch eine entsprechende
          Einstellung Ihrer Browser-Software verhindern; wir weisen Sie jedoch darauf hin, dass Sie in diesem Fall gegebenenfalls
          nicht sämtliche Funktionen dieser Website voll umfänglich nutzen können. Durch die Nutzung dieser Website erklären
      ...
      meta: [
        {
          'property': 'og:title',
          'content': 'team2work',
          'template': chunk => `${chunk} - Impressum`,
          'vmid': 'og:title'
        },
        {
        ...
        {
          'property': 'og:url',
          'content': 'https://team2work.at/#/impressum'
        }
      ]
    }
}
...
.info-block {
    @include rem((padding: 60px 0 30px 0));
    hr {
